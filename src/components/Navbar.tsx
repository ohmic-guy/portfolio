...
const Navbar = () => {
  ...
  return (
    <nav className="hidden md:block fixed top-0 left-0 right-0 z-50 bg-[#050510]/96 backdrop-blur-xl border-b border-cyan-500/15 shadow-[0_10px_40px_rgba(0,0,0,0.35)]" data-testid="navbar">
